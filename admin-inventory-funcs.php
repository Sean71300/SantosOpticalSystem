            ...
            echo "<tr>
                    ...
                    <td>
                        <form method='post'>
                            ...
                            <button type='submit' class='btn btn-success align-middle' name='editProductBtn' style='font-size:12px'><i class='fa-solid fa-pen align-middle'></i></button>
                        </form>
                    </td>
                    <td>
                        <form method='post'>
                            ...
                            <input type='hidden' name='productBranchID' value='" . htmlspecialchars($row['ProductBranchID']) . "' />
                            <input type='hidden' name='productID' value='" . htmlspecialchars($row['ProductID']) . "' />
                            <button type='submit' class='btn btn-danger align-middle' name='deleteProductBtn' value='deleteProductBtn' style='font-size:12px'><i class='fa-solid fa-trash align-middle'></i></button>
                        </form>
                    </td>
                </tr>";
        }
