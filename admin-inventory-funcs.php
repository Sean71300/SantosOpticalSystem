            ...
            echo "<tr>
                    ...
                    <td class='align-middle'>
                        <form method='post'>
                            ...
                            <button type='submit' class='btn btn-success mt-1' name='editProductBtn' style='font-size:18px'><i class='fa-solid fa-pen'></i></button>
                        </form>
                    </td>
                    <td class='align-middle'>
                        <form method='post'>
                            ...
                            <input type='hidden' name='productBranchID' value='" . htmlspecialchars($row['ProductBranchID']) . "' />
                            <input type='hidden' name='productID' value='" . htmlspecialchars($row['ProductID']) . "' />
                            <button type='submit' class='btn btn-danger mt-1' name='deleteProductBtn' value='deleteProductBtn' style='font-size:18px'><i class='fa-solid fa-trash'></i></button>
                        </form>
                    </td>
                </tr>";
        }
