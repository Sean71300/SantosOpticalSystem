...
@media (max-width: 768px) {
    ...
    <body>
        ...
        <!-- Continue with the same structure as your original code -->
...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="services2-section">
        ...
        <div class="image-container">
            <img src="Images/os2.png" alt="B2T1 Promo" class="services2-img">
        </div>
    </div>
</div>
...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="services3-section">
        ...
        <div class="image-container">
            <img src="Images/os3.png" alt="Fast Service" class="services3-img">
        </div>
    </div>
</div>
...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="services4-section">
        ...
        <div class="image-container">
            <img src="Images/os4.png" alt="Warranty" class="services4-img">
        </div>
    </div>
</div>
...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="services5-section">
        ...
        <div class="image-container">
            <img src="Images/os5.png" alt="Lens Guarantee" class="services5-img">
        </div>
    </div>
</div>

<!-- Fixed Footer (removed duplicate) -->
