<?php
// virtual-try-on.php (fixed FaceMesh version)
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <!-- NEW MediaPipe FaceMesh (v2) -->
  <script type="module">
    import { FaceMesh } from 'https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh@0.4.1675469240/face_mesh.js';
    import { Camera } from 'https://cdn.jsdelivr.net/npm/@mediapipe/camera_utils@0.3.1675469240/camera_utils.js';
    import { drawConnectors, FACEMESH_TESSELATION, FACEMESH_LEFT_EYE, FACEMESH_RIGHT_EYE, FACEMESH_LIPS } 
      from 'https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils@0.3.1675469240/drawing_utils.js';
...
<body>
  ...
  <script type="module">
    ...
    const faceMesh = new FaceMesh({
      locateFile: (file) => `https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh@0.4.1675469240/${file}`,
    });
