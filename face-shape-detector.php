            ...
            <?php else: ?>
                ...
                <div class="recommendation">
                    ...
                    <div class="frame-showcase">
                        ...
                        if ($shapeId) {
                            try {
                                // Check if connect function exists, if not include it
                                ...
                                // Fetch 3 random frames for this face shape
                                ...
                                // Silent fail - show generic message instead of breaking page
                                echo '<p class="text-center w-100" style="color: #666;">Unable to load frame recommendations. Browse our full collection below.</p>';
                            }
                        }
                        ?>
                    </div>
