<div class="forNavigationbar sticky-start">
    <nav class="navbar navbar-expand-lg bg-body-tertiary flex-column align-items-start h-100">
        <div class="container-fluid flex-column h-100 d-flex justify-content-between">
            <div class="w-100">
            ...
            <div class="w-100">
                <a class="navbar-brand fw-bold d-flex align-items-center justify-content-center py-3" href="index.php">
