...
<div class="container-fluid py-5" style="background-color: #fdfdfd;">
    <div class="container text-center my-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-6 text-center">
                <img src="imgm1.png" alt="Minima M608" class="product-img">
            </div>
            <div class="col-md-4 col-sm-6 text-center">
                <img src="imgm2.png" alt="Paul Hueman" class="product-img">
            </div>
            <div class="col-md-4 col-sm-6 text-center">
                <img src="imgm3.png" alt="Paul Hueman PHF" class="product-img">
            </div>
        </div>
...
<div class="container-fluid py-5" style="background-color: #e0e0e0;">
    <div class="container">
...
<div class="container-fluid text-center bg-light vh-100 d-flex flex-column justify-content-center" style="background-color: #f8f5f2; height: 100vh;">
